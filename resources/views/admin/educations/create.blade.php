                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="degree" value="{{ old('degree') }}"
                                            class="form-control filter-input" placeholder="Enter Degree"required >
                                        @error('degree')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_date" value="{{ old('start_date') }}" class="form-control filter-input"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_date" value="{{ old('end_date') }}" class="form-control filter-input"
