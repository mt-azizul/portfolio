                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group div">
                                        ...
                                        <input type="file" id="file" name="profic" value="{{ old('profic') }}"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="blood_group" value="{{ old('blood_group') }}" class="form-control"
                                            required>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Bio:</label>
                                        <textarea type="text" name="bio" value="{{ old('bio') }}" class="form-control filter-input"
