                  ...
                  <form action="{{ route('skills.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between">
                                <h4>Skills Info</h4> <button class="btn btn-sm btn-success" id="skillAddBtn"><i class="fa fa-plus"></i></button>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]"
                                            class="form-control filter-input" placeholder="Enter Skill Name" required >
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
            ...
            $('.select2').select2();
             ...
             <div class="row" id="skill-${i}">
                ...
                <div class="col-lg-5 col-md-5 col-sm-11">
                    <div class="form-group">
                        <input type="text" name="level[]" class="form-control filter-input"
