                ...
                <form action="{{ route('experiences.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            <h4>Experiences Info</h4> <button class="btn btn-sm btn-success" id="AddBtn"><i
                        ...
                        <div class="row border border-primary">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company[]" class="form-control filter-input" placeholder="Enter Company Name" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label class="">Location:</label>
                                    <input type="text" name="location[]" class="form-control filter-input" placeholder="Enter Location">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
